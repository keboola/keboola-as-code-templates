...
### FLOW: Flow [SHOPIFY-TO-GOOGLESHEET] 

The Flow gets the data from Shopify Data Source, transforms the data, runs the RFM analysis and optionally writes the data into Google sheet data destination.
