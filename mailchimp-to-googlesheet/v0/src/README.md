...
### DD: Data Destination [OUT-MAILCHIMP-GSHEET]

The data destination loads data into a Google sheet.

### FLOW: Flow [KEBOOLA-MAILCHIMP] 

The Flow gets the data from Mailchimp Data Source, transforms the data and optionally writes the data into a Google Sheets.
