  ...
  configurations: std.filter(function(v) v != null,[
    ...
    },
    {
      ...
      relations: [
        {
          componentId: "keboola.orchestrator",
          configId: ConfigId("thoughtspot-ecommerce-shopify-orchestration"),
          type: "schedulerFor"
        }
      ],
      rows: []
    ...
    if HasProjectBackend("snowflake") then {
      ...
      id: ConfigId("in-ecommerce-shopify-transformation1-prepare-input-tables"),
      path: "transformation/keboola.google-bigquery-transformation/in-ecommerce-shopify-transformation1-prepare-input-tables",
      rows: [],
      metadata: { "KBC.configuration.folderName": "[THOUGHTSPOT-ECOMMERCE-SHOPIFY]"}
    },
    },
    ...
    if HasProjectBackend("snowflake") then {
      ...
      componentId: "keboola.google-bigquery-transformation",
      id: ConfigId("in-ecommerce-shopify-transformation2-data-preparation"),
      path: "transformation/keboola.google-bigquery-transformation/in-ecommerce-shopify-transformation2-data-preparation",
      rows: [],
      metadata: { "KBC.configuration.folderName": "[THOUGHTSPOT-ECOMMERCE-SHOPIFY]"}
    },
    },
