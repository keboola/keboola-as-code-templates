{ mainConfig: {
  ...
  configurations: std.filter(function(v) v != null,[
	...
	if HasProjectBackend("snowflake") then {
	  ...
	  id: ConfigId("in-ecommerce-shopify-transformation1-prepare-input-tables"),
	  path: "<common>/in-ecommerce-shopify/v0/src/transformation/keboola.google-bigquery-transformation/in-ecommerce-shopify-transformation1-prepare-input-tables",
	  rows: [],
	  metadata: { "KBC.configuration.folderName": "[THOUGHTSPOT-ECOMMERCE-SHOPIFY]"}
	},
    },
	...
	if HasProjectBackend("snowflake") then {
	  ...
	  componentId: "keboola.google-bigquery-transformation",
	  id: ConfigId("in-ecommerce-shopify-transformation2-data-preparation"),
	  path: "<common>/in-ecommerce-shopify/v0/src/transformation/keboola.google-bigquery-transformation/in-ecommerce-shopify-transformation2-data-preparation",
	  rows: [],
	  metadata: { "KBC.configuration.folderName": "[THOUGHTSPOT-ECOMMERCE-SHOPIFY]"}
	},
    },
