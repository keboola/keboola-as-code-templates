{
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-" + ConfigId("in-ecommerce-shopify-extractor-10697799") + ".bdm_products",
          destination: "out.c-ecommerce-wr-" + ConfigId("in-ecommerce-shopify-extractor-10697799") + ".bdm_products.csv",
          changed_since: "",
          columns: [
            "PRODUCT_ID",
            "PRODUCT_CODE",
  ...
  parameters: {
    tables: [
      {
        dbName: "bdm_products",
        tableId: "out.c-ecommerce-wr-" + ConfigId("in-ecommerce-shopify-extractor-10697799") + ".bdm_products",
        incremental: false,
        items: [
          {
            name: "PRODUCT_ID",
