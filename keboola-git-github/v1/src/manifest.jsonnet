{ mainConfig: {
  ...
  configurations: std.filter(function(v) v != null,[
    ...
    if HasProjectBackend("bigquery")==true then
    {
      ...
      path: "<common>/in-git-github/transformation/keboola.google-bigquery-transformation/transformation1-organization-user-in-git-github_bq",
      metadata: {
    ...
    if HasProjectBackend("bigquery")==true then
    {
      ...
      path: "<common>/in-git-github/transformation/keboola.google-bigquery-transformation/transformation2-output-tables-creation-in-git-github_bq",
      metadata: {
        "KBC.configuration.folderName": "GIT-GITHUB",
      },
      rows: [],
    ...
    if InputIsAvailable("wr-postgresql-db-hostname") then
    {
      ...
      path: "<common>/out-git-postgresql/v0/src/writer/keboola.wr-db-pgsql/out-git-postgresql-writer",
      rows: [
        {
          id: ConfigRowId("event"),
          path: "rows/event",
