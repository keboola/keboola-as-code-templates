{
  storage: {
    input: {
      tables: [
        {
          source: "out.c-thoughtspot-wr-15471164.ga_page_behaviour",
          destination: "out.c-thoughtspot-wr-15471164.ga_page_behaviour.csv",
          changed_since: "",
          columns: [
            "id_TBE",
            "ga_date",
    ...
    tables: [
      {
        ...
        tableId: "out.c-thoughtspot-wr-15471164.ga_page_behaviour",
        incremental: false,
        items: [
          {
            name: "id_TBE",
