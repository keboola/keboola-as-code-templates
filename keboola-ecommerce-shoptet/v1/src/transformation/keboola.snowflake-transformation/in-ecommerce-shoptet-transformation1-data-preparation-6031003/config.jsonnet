{
  ...
  storage: {
    ...
    output: {
      tables: [
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_customers",
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_orders",
          source: "bdm_orders",
          primary_key: [
            "ORDER_ID",
          ],
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_order_lines",
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_products",
          source: "bdm_products",
          primary_key: [
            "PRODUCT_ID",
          ],
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_analyze_clv_by_order_count",
          source: "analyze_clv_by_order_count",
        },
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_analyze_clv_by_time_from_previous_order",
          source: "analyze_clv_by_time_from_previous_order",
        },
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_billing_type",
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_shipping_type",
        ...
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".bdm_product_margin_over_time",
          source: "bdm_product_margin_over_time",
        },
        {
          destination: "out.c-ecommerce-bdm-" + ConfigId("in-ecommerce-shoptet-extractor-6031003") + ".out_shop",
          source: "out_shoptet",
        },
      ],
    },
