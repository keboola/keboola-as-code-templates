{
  parameters: {
    tableId: "out.c-thoughtspot-wr-" + ConfigId("thoughtspot-hubspot-snowflake-extractor-10708760") + ".HUBSPOT_CONTACTS",
  ...
  storage: {
    input: {
      tables: [
        {
          source: "out.c-thoughtspot-wr-" + ConfigId("thoughtspot-hubspot-snowflake-extractor-10708760") + ".HUBSPOT_CONTACTS",
          destination: "out.c-thoughtspot-wr-" + ConfigId("thoughtspot-hubspot-snowflake-extractor-10708760") + ".HUBSPOT_CONTACTS.csv",
          columns: [
            "ID",
            "ARCHIVED",
