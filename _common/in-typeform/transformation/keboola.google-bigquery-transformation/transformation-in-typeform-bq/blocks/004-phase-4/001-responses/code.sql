--The reference for the question the answer relates to. Use the ref value to match answers with questions. The Responces payload only includes ref for the fields where you specified them when you created the form.
...
(SELECT
	CONCAT( ra.responses_pk, '_', ra.field_id) AS response_id,
--    ra."response_id",'_' --Unique ID for the response. Note that response_id values are unique per form but are not unique globally.
