...
CREATE TABLE `bdm_orders` (
  ...
  ORDER_CURRENCY STRING(255),
  ORDER_CUSTOMER_EMAIL STRING(255),
  ORDER_REMARK STRING(255),
  ORDER_PACKAGE_NUMBER STRING(255),
...
CREATE TABLE `bdm_order_lines` (
  ORDER_ID STRING(255),
  ORDER_LINE_ID STRING(255) NOT NULL,
  ORDER_DATE DATETIME,
  ORDER_LINE_PRODUCT_ID STRING(255),
  ITEMNAME STRING(1024),
  ORDER_ITEM_TYPE STRING(255),
