...
INSERT INTO  "bdm_customers" 
      SELECT 
            ...
            CASE WHEN C."orders_count" = '' THEN 0 
                  ELSE C."orders_count"::NUMERIC
                  END				           AS ORDERS_COUNT_TOTAL,
            CASE WHEN C."total_spent" = '' THEN 0
                  ELSE C."total_spent"::NUMERIC
                  END		                       AS TOTAL_SPEND,
            DIV0(CASE WHEN C."total_spent" = '' THEN 0
                        ELSE C."total_spent"::NUMERIC
                        END, 
                  CASE WHEN C."orders_count" = '' THEN 0
                        ELSE C."orders_count"::NUMERIC
