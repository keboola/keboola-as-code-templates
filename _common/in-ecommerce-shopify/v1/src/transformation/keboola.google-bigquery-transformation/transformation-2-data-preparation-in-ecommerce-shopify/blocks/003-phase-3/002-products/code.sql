...
SELECT
  ...
  IF(PT.TOTAL_UNITS_SOLD IS NULL, 0, PT.TOTAL_UNITS_SOLD) AS TOTAL_UNITS_SOLD,
  IF(PT.UNITS_SOLD_LAST_MONTH IS NULL, 0, PT.UNITS_SOLD_LAST_MONTH) AS UNITS_SOLD_LAST_MONTH,
  IF(PT.AVG_SOLD_UNITS_PER_DAY IS NULL, 0, PT.AVG_SOLD_UNITS_PER_DAY) AS AVG_SOLD_UNITS_PER_DAY,
  IF(
    PT.AVG_SOLD_UNITS_PER_DAY = 0 AND NOT PV.PRODUCT_STOCK_AMOUNT IS NULL,
    0,
    PV.PRODUCT_STOCK_AMOUNT / PT.AVG_SOLD_UNITS_PER_DAY
  ) AS STOCK_REFILL,
  FALSE AS IS_DELETED
FROM `product` AS P
