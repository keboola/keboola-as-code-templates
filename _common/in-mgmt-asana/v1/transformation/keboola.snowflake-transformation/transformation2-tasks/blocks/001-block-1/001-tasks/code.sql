...
INSERT INTO "out_task"
        ...
        nullif(replace(left("td"."created_at", 19), 'T', ' '),'')        													AS "created_at",
        nullif(replace(left("td"."completed_at", 19), 'T', ' '),'')      													AS "completed_at",
        nullif("td"."due_on",'')                                                                  AS "due_date",
        iff("td"."completed" = 'True', NULL, datediff(DAY, nullif("td"."due_on", ''), current_date)) AS "days_past_due",
        ...
        iff("td"."completed" = 'True', 'true', 'false')                                           AS "completed",
...
-- table  has empty columns
INSERT INTO "out_task_custom_field"
    ("task_custom_field_id", "task_id", "task_custom_field", "task_custom_field_value")
VALUES
    ('0', '', '', '');
