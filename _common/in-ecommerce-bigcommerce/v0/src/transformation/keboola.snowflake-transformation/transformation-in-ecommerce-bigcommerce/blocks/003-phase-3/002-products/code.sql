...
CREATE OR REPLACE TABLE "tmp_product_totals" 
 AS
    SELECT DISTINCT
...
INSERT INTO "bdm_products"
    SELECT DISTINCT
        ...
        , iff(P."sale_price" = '', 0, P."sale_price")                  AS PRODUCT_STANDARD_PRICE
        , iff(P."cost_price" = '', 0, P."cost_price")                  AS PRODUCT_PURCHASE_PRICE						 
        , iff(P."inventory_level" = '', null, "inventory_level")	   AS PRODUCT_STOCK_AMOUNT
        ...
        , DIV0(iff(P."inventory_level" = '', null, "inventory_level"), PT.AVG_SOLD_UNITS_PER_DAY ) AS STOCK_REFILL
        , FALSE                                                        AS IS_DELETED
        
    FROM "products" P
        LEFT JOIN "tmp_product_totals" PT 
