[
  ...
  },
  {
  ...
  },
   {
    ...
    description: "Select period from which you want to get the data for daily statistics.",
    type: "string",
    kind: "select",
  ...
  },
  {
    ...
    description: "Select period to date you want to get the data for daily statistics.",
    type: "string",
    kind: "select",
    options: [
      {
