      ...
      tables: [
        {
          ...
          source: "in.c-kds-team-ex-google-analytics-" + ConfigId("in-thoughtspot-gaa-extractor") + ".raw_ad_analytics",
          where_column: "",
          where_operator: "eq",
          where_values: [],
        },
        {
          ...
          source: "in.c-kds-team-ex-google-analytics-" + ConfigId("in-thoughtspot-gaa-extractor") + ".raw_demographic_audience",
          where_column: "",
          where_operator: "eq",
          where_values: [],
        },
        {
          ...
          source: "in.c-kds-team-ex-google-analytics-" + ConfigId("in-thoughtspot-gaa-extractor") + ".raw_geo_audience",
          where_column: "",
          where_operator: "eq",
          where_values: [],
        },
        {
          ...
          source: "in.c-kds-team-ex-google-analytics-" + ConfigId("in-thoughtspot-gaa-extractor") + ".raw_page_behaviour",
          where_column: "",
          where_operator: "eq",
          where_values: [],
        },
        {
          ...
          source: "in.c-kds-team-ex-google-analytics-" + ConfigId("in-thoughtspot-gaa-extractor") + ".raw_site_statistics",
          where_column: "",
          where_operator: "eq",
          where_values: [],
        },
        {
          ...
          source: "in.c-kds-team-ex-google-analytics-" + ConfigId("in-thoughtspot-gaa-extractor") + ".raw_traffic_source",
          where_column: "",
          where_operator: "eq",
          where_values: [],
        },
