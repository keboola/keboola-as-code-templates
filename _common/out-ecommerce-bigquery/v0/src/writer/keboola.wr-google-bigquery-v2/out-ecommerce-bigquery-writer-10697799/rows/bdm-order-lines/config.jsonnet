{
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-" + ConfigId("out-ecommerce-bigquery-writer-10697799") + ".bdm_order_lines",
          destination: "out.c-ecommerce-wr-" + ConfigId("out-ecommerce-bigquery-writer-10697799") + ".bdm_order_lines.csv",
          changed_since: "",
          columns: [
            "ORDER_ID",
            "ORDER_LINE_ID",
    ...
    tables: [
      {
        ...
        tableId: "out.c-ecommerce-wr-" + ConfigId("out-ecommerce-bigquery-writer-10697799") + ".bdm_order_lines",
        incremental: false,
        items: [
          {
            name: "ORDER_ID",
