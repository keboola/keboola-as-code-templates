{
  storage: {
    input: {
      tables: [
        {
          source: "out.c-ecommerce-wr-" + ConfigId("out-ecommerce-bigquery-writer-10697799") + ".bdm_orders",
          destination: "out.c-ecommerce-wr-" + ConfigId("out-ecommerce-bigquery-writer-10697799") + ".bdm_orders.csv",
          changed_since: "",
          columns: [
            "ORDER_ID",
            "ORDER_DATE",
  ...
  parameters: {
    tables: [
      {
        dbName: "bdm_orders",
        tableId: "out.c-ecommerce-wr-" + ConfigId("out-ecommerce-bigquery-writer-10697799") + ".bdm_orders",
        incremental: false,
        items: [
          {
            name: "ORDER_ID",
