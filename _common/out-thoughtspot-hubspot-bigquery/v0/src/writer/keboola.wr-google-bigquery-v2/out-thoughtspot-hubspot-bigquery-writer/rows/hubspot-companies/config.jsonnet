{
  storage: {
    input: {
      tables: [
        {
          source: "out.c-thoughtspot-wr-" + InstanceIdShort() + ".HUBSPOT_COMPANIES",
          destination: "out.c-thoughtspot-wr-" + InstanceIdShort() + ".HUBSPOT_COMPANIES.csv",
          changed_since: "",
          columns: [
            "ID",
            "INDUSTRY",
    ...
    tables: [
      {
        ...
        tableId: "out.c-thoughtspot-wr-" + InstanceIdShort() + ".HUBSPOT_COMPANIES",
        incremental: false,
        items: [
          {
            name: "ID",
