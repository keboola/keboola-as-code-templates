{ mainConfig: {
  ...
  configurations: std.filter(function(v) v != null,[
    ...
    {
      componentId: "keboola.snowflake-transformation",
      id: ConfigId("in-ecommerce-shopify-transformation-tables-creation"),
      path: "<common>/in-ecommerce-shopify/v0/src/transformation/keboola.snowflake-transformation/in-ecommerce-shopify-transformation-tables-creation",
      rows: [],
      metadata: { "KBC.configuration.folderName": "[ECOMMERCE-SHOPIFY]"}
    },
