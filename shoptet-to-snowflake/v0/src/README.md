...
### FLOW: Flow [SHOPTET-TO-SNOWFLAKE]

The Flow gets the data from Shoptet Data Source, transforms the data, runs the RFM analysis and optionally writes data into s Snowflake data destination.
