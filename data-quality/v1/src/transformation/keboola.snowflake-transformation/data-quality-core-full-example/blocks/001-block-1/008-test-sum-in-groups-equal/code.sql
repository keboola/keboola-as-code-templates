// Tests whether sum of values in quantity in group by customer_id in orders is equal to provided opposite in "orders"
// This example will not match anything
...
AS SELECT "customer_id", "quantity"*1.01 AS "quantityNew" FROM "orders";

// Tests whether sum of values in quantity in group by customer_id in orders is equal to provided opposite in "orders_new"
// This example will not match anything
