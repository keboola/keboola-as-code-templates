{ mainConfig: {
  ...
  configurations: [
    ...
    if HasProjectBackend("snowflake") then {
      ...
      componentId: "keboola.shared-code",
      id: ConfigId("shared-code"),
      path: "_shared/keboola.google-bigquery-transformation",
      rows: [
        {
          id: ConfigRowId("data-quality-core"),
          path: "codes/data-quality-core",
    ...
    if HasProjectBackend("snowflake") then {
      ...
      componentId: "keboola.variables",
      id: ConfigId("Variables definition for keboola.google-bigquery-transformation/913123604"),
      path: "variables",
      relations: [
        {
          componentId: "keboola.google-bigquery-transformation",
    ...
    if HasProjectBackend("snowflake") then {
      ...
      componentId: "keboola.variables",
      id: ConfigId("Variables definition for keboola.google-bigquery-transformation/913123605"),
      path: "variables",
      relations: [
        {
          componentId: "keboola.google-bigquery-transformation",
