  ...
  storage: {
    input: {
      tables: [
        ...
        {
          source: "in.c-kds-team-ex-kbc-project-metadata-v2-" + ConfigId("metadata-activity-center") + ".storage_buckets",
        ...
        {
          source: "in.c-keboola-ex-telemetry-data-" + ConfigId("telemetry-activity-center") + ".kbc_branch",
