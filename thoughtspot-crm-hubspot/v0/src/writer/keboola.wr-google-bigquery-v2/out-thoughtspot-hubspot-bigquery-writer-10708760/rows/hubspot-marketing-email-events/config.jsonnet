{
  storage: {
    input: {
      tables: [
        {
          source: "out.c-thoughtspot-wr-" + ConfigId("in-thoughtspot-hubspot-extractor-10708760") + ".HUBSPOT_MARKETING_EMAIL_EVENTS",
          destination: "out.c-thoughtspot-wr-" + ConfigId("in-thoughtspot-hubspot-extractor-10708760") + ".HUBSPOT_MARKETING_EMAIL_EVENTS.csv",
          changed_since: "",
          columns: [
            "APP_ID",
            "APP_NAME",
    ...
    tables: [
      {
        ...
        tableId: "out.c-thoughtspot-wr-" + ConfigId("in-thoughtspot-hubspot-extractor-10708760") + ".HUBSPOT_MARKETING_EMAIL_EVENTS",
        incremental: false,
        items: [
          {
            name: "APP_ID",
